    ...
    <section id="section-gallery" class="container">
        <div class="row">
            ...
            <div>
                ...
                <button class="btn btn-default filter-button" data-filter="type1">Mercesbenz</button>
                <button class="btn btn-default filter-button" data-filter="type2">Audi</button>
            ...
            <div id="lightgallery" class="max-w-xl mx-auto p-10">
                <div class="gallery_product col-sm-4 col-md-3 col-lg-4 filter type1">
                    <a href="./public/images/trang_gallery/hangxe_logo/mercedes/c-200-avantgarde-dai-dien-4e11.jpg" data-fancybox="gallery-Mercesbenz">
                        <img src="./public/images/trang_gallery/hangxe_logo/mercedes/c-200-avantgarde-dai-dien-4e11.jpg" class="img-fluid">
                    </a>
                    <div style="display: none;">
                        <a href="./public/images/trang_gallery/hangxe_logo/mercedes/dai-dien-6934.jpg" data-fancybox="gallery-Mercesbenz">
                            <img src="./public/images/trang_gallery/hangxe_logo/mercedes/dai-dien-6934.jpg" class="img-fluid">
                        </a>
                    </div>
                </div>
